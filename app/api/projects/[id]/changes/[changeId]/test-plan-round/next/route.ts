...
import { TEST_PLAN_DELEGATED_ROUND } from "@/server/services/delegated-round-phases";
...
/**
 * Starts another adversarial TestPlan round on a settled one.
 *
...
export async function POST(
  ...
  return handleDelegatedNextRoundRequest({
    ...
    projectId,
    changeId,
    actionId: "request_test_plan_changes",
