...
const P0: Blocker = { id: "B-1", kind: "finding", severity: "P0", title: "范围冲突", where: null, why: null, owner: null };
const P1: Blocker = { id: "B-2", kind: "finding", severity: "P1", title: "验收不可测", where: null, why: null, owner: null };
